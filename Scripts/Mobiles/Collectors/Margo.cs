...
using Server.Items;
using Server.Engines.Quests; //ADD For Humility Quest
...
namespace Server.Items
{
	public class UnderstandingAnimals : BaseCollectionMobile
	{
		...
		public override void Init()
		{
			...
			//Edit
            Donations.Add(new CollectionItem(typeof( BlackScales ), 0x26B4, 1060883, 0x455, 20 ) );
            Donations.Add(new CollectionItem(typeof( GreenScales ), 0x26B4, 1060883, 0x851, 20 ) );
            Donations.Add(new CollectionItem(typeof( WhiteScales ), 0x26B4, 1060883, 0x8FD, 20 ) );
            Donations.Add(new CollectionItem(typeof( BlueScales ), 0x26B4, 1060883, 0x8B0, 20 ) );
	        //Edit End
			
			int[] hues = new int[] { 0x1E0, 0x190, 0x151 };
            Rewards.Add( new CollectionHuedItem( typeof( SpecialPrintingOfVirtue), 0x0FEF, 1075793, 0x47, 5000.0, hues ) ); //ADD for Humility Quest
